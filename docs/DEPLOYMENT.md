...
7. Enable preview deployments on every PR; the currently verified development branch is recorded in
   `PROJECT_STATUS.md`, while older preview commit references remain historical evidence only.
